...
<a class="w3-btn w3-margin-bottom" href="js_intro.asp" style="font-size: 18px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:6px;">Start learning JavaScript now &raquo;</a>
</div>
...
<p><a href="js_quiz.asp" class="ws-btn">Start JavaScript Quiz!</a></p>
<br>
